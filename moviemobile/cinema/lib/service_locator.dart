...
Future<void> setUp() async {
  ...
  locator.registerLazySingleton<RemoteDataSource>(()=>RemoteDataSourceImp(dio: locator<Dio>()));
  locator.registerLazySingleton<AuthRepo>(()=>AuthRepoImp(remoteDataSource: locator<RemoteDataSource>(), localDataSource: locator<LocalDataSource>(), networkInfo: locator<NetworkInfo>()));
  locator.registerLazySingleton<RegisterUsecase>(()=>RegisterUsecase(authRepo: locator<AuthRepo>()));
  locator.registerLazySingleton<LoginUsecase>(()=>LoginUsecase(authRepo: locator<AuthRepo>()));
}
